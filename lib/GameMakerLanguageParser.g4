...
expression
    ...
    | assignmentExpression # AssignmentExpressionLabel
...
structDeclaration
    : Function identifier (parameterList? Constructor block | Constructor parameterList? block)
    ;
...
macroToken
    ...
    | Until | Repeat | Function | With | Default | If | Throw | Delete
