...
// This class defines a complete generic visitor for a parse tree produced by GameMakerLanguageParser.
...
export default class GameMakerLanguageParserVisitor extends antlr4.tree.ParseTreeVisitor {
	...
	// Visit a parse tree produced by GameMakerLanguageParser#AssignmentExpressionLabel.
	visitAssignmentExpressionLabel(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	// Visit a parse tree produced by GameMakerLanguageParser#inheritanceClause.
	visitInheritanceClause(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by GameMakerLanguageParser#structDeclaration.
	...
	// Visit a parse tree produced by GameMakerLanguageParser#macroToken.
	visitMacroToken(ctx) {
	  return this.visitChildren(ctx);
	}
